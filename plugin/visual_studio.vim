...
if ! exists ('g:visual_studio_quickfix_errorformat_cpp1')
	let g:visual_studio_quickfix_errorformat_cpp1 = '\ %#%f(%l)\ :\ %m'
endif
...
if ! exists ('g:visual_studio_quickfix_errorformat')
    ...
    let s:qf2 = g:visual_studio_quickfix_errorformat_cpp1
    let s:qf3 = g:visual_studio_quickfix_errorformat_csharp
    let s:qf4 = g:visual_studio_quickfix_errorformat_find_results
    let g:visual_studio_quickfix_errorformat = s:qf1.',\\'.s:qf2.',\\'.s:qf3.',\\'.s:qf4
endif
